...
const AIDecisionExplanation: React.FC<AIDecisionExplanationProps> = ({
    ...
    const points = [
        { text: "Verified defense contracts with 24-month revenue visibility.", status: "pass" },
        { text: "Strong net-worth position from recent Series C funding (MCA Verified).", status: "pass" },
        { text: "Supply-chain audit shows 99.2% inventory accuracy.", status: "pass" },
        { text: "Slight GST revenue drop in Dec-Feb (Temporary factory upgrade).", status: "warn" },
        { text: "DSCR coverage remains robust at 2.1x post-sanction.", status: "pass" },
        { text: "Moderate leverage (D/E ratio) detected in latest audit.", status: "warn" },
    ];
    ...
    return (
        <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="bg-white/80 backdrop-blur-xl rounded-[32px] border border-white/40 shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden h-full group"
        >
            {/* Header Section */}
            <div className="p-8 border-b border-slate-100 bg-gradient-to-br from-slate-50/50 to-white/50">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-black text-[#1E293B] tracking-tight">AI Decision Panel</h3>
                            <p className="text-[10px] font-bold text-blue-600 uppercase tracking-[0.2em] mt-0.5">XAI Neural Interpretation</p>
                        </div>
                    </div>
                    <motion.div
